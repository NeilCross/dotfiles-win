...
function Write-Theme {
    ...
    if (Test-VirtualEnv) {
        ...
        $prompt += Write-Prompt -Object "" -ForegroundColor $sl.Colors.SessionInfoBackgroundColor -BackgroundColor $sl.Colors.PromptBackgroundColor
    }
...
$sl.PromptSymbols.PromptIndicator = 'λ'
